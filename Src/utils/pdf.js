...
function generateHeader(doc) {
  doc
    .image("logoA.png", 50, 15, { width: 90 })
    .fillColor("#444444")
    .fontSize(20)
    .text("   Abdo 10.", 110, 57)
    .fontSize(10)
    .text("Abdo Inc.", 200, 50, { align: "right" })
...
function generateInvoiceTable(doc, invoice) {
  ...
  //   doc.text("No items found for this invoice", 50, 330);
  //   return;
  // }
  let i;
  ...
  for (i = 0; i < invoice.items.length; i++) {
    ...
    generateTableRow(
      doc,
      position,
      item.title || "No Title", // Fallback to 'No Title' if title is missing
